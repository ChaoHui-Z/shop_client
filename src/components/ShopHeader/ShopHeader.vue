<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="isShowpinpai=true">
    ...
    <div class="activity-sheet" v-show="isShowyouhui">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close" @click="isShowyouhui=false">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
      <div class="activity-sheet-cover" @click="isShowyouhui=false"></div>
    </div>
  </div>
</template>
